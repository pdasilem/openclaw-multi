...
type OverlayConfig struct {
	...
	OpenClawUpdateSource       string        `yaml:"openclaw_update_source"`
	OpenClawUpdateCommand      string        `yaml:"openclaw_update_command"`
...
func Defaults() *OverlayConfig {
	return &OverlayConfig{
		...
		PortRangeStep:         20,
		NodeVersionMin:        "24",
		OpenClawUpdateSource:  "openclaw@latest",
		OpenClawUpdateCommand: "npm install --global openclaw@latest",
